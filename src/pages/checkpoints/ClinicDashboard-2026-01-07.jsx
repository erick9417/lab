                  ...
                  filteredPatients.map((patient) => (
                    <div key={patient.id} className="flex items-center justify-between p-4 hover:bg-gray-50 transition">
                      ...
                      >
                        ...
                        {/* Solo listar nombres: ocultar notas por ahora */}
                      </button>
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-baseline gap-3 mb-2">
                              <span className="bg-[#003C63] text-white text-xs font-bold px-3 py-1 rounded-md">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs text-gray-600 mt-3">
                              <div>
                            ...
                            <div className="mt-2 flex items-center gap-3 text-xs text-gray-500">
                              <span className="inline-flex items-center gap-1">
                                ...
                                {requests.filter(r => r.patient_id === req.patient_id).length} adjunto(s)
                              </span>
                              <button
                                type="button"
                                onClick={() => navigate(`/request/${req.id}`)}
